...
class Apartment extends House {
  ...
  getAptInfo() {
    return `${this.year}에 지어진 ${this.name} 아파트의 총 층수는 ${this.floor}층 이며, 창문의 개수는 ${this.window}개 이다.`;
  }

  // 오버라이딩(overriding)
  // 부모 클래스의 정의되어 있는 메서드 이름을 동일하게 쓰되, 내용은 다를 때
  getWindow() {
