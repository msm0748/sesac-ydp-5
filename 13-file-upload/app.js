...
app.post('/upload', uploadDetail.single('userfile'), (req, res) => {
  ...
  //   originalname: 'á\x84\x8Cá\x85¦á\x84\x86á\x85©á\x86.png', // 원본 파일명
  //   encoding: '7bit', // 파일 인코딩 타입
  //   mimetype: 'image/png', // 파일 타입
  //   destination: 'uploads/', // 파일 저장 경로
  //   filename: '4b43e5750ef0038c6f5abe6f597cd500', // destination 저장된 파일명
  //   path: 'uploads/4b43e5750ef0038c6f5abe6f597cd500', // 업로드된 파일 전체 경로
  //   size: 782274 // 파일 크기
  // }
});
