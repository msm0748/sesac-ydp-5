...
console.log(document.getElementsByClassName('pink')[1]); // 유사 배열

// 3. getElementsByTagName
console.log(document.getElementsByTagName('div'));

// 4. getElementsByName
console.log(document.getElementsByName('id')); // NodeList
...
Array.from(document.getElementsByClassName('pink')).forEach((el) => console.log(el));
