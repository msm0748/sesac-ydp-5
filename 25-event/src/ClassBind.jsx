...
class ClassBind extends Component {
  ...
  // 화살표 함수는 this가 아예 없음! 선언될 시점에 상위 스코프가 this에 바인딩
  printConsole = () => {
    console.log('this', this);
  };
  ...
  render() {
    return (
      <div>
        ...
        <button onClick={() => this.printConsole2('msg')}>printConsole(인자 O)</button>
        <button onClick={this.printConsole2.bind(null, 'msg')}>printConsole(인자 O, bind)</button>
      </div>
    );
  }
}
